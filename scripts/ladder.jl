...
rungs = [
    ...
    ("0t bare bones, unmet 5 %",  (; unmet_demand_share = 0.05), (; unmet_demand_share = 0.05)),
    ("0u bare bones, unmet 10 %", (; unmet_demand_share = 0.10), (; unmet_demand_share = 0.10)),
    ("9a + co-op theatre",       (; planning_margin = 0.1, GOV_DEBT..., DEP..., entertainment = true, government_bonds = true, number_of_theatres = 2, number_of_farms = 4, number_of_bakeries = 4, cooperative_theatres = 1, ownership = :mixed, share_market = true, forward_valuation = true, required_yield_dispersion = 0.002), (; planning_margin = 0.1, GOV_SUMSY..., entertainment = true, number_of_theatres = 2, number_of_farms = 4, number_of_bakeries = 4, cooperative_theatres = 1, ownership = :mixed, share_market = true, forward_valuation = true, required_yield_dispersion = 0.002)),
    ("9b worker & consumer forms", (; planning_margin = 0.1, GOV_DEBT..., DEP..., entertainment = true, government_bonds = true, number_of_theatres = 2, number_of_farms = 4, number_of_bakeries = 4, cooperative_theatres = 1, cooperative_form_farms = :worker, cooperative_form_bakeries = :worker, cooperative_form_theatres = :consumer, ownership = :mixed, share_market = true, forward_valuation = true, required_yield_dispersion = 0.002), (; planning_margin = 0.1, GOV_SUMSY..., entertainment = true, number_of_theatres = 2, number_of_farms = 4, number_of_bakeries = 4, cooperative_theatres = 1, cooperative_form_farms = :worker, cooperative_form_bakeries = :worker, cooperative_form_theatres = :consumer, ownership = :mixed, share_market = true, forward_valuation = true, required_yield_dispersion = 0.002)),
