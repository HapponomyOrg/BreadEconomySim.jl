...
function validate_cooperatives(p::SimulationParameters)
    ...
    all(in((:income, :consumption, :wealth, :profit, :parking, :land)), keys(p.tax_levers)) || throw(ArgumentError("tax_levers families: income, consumption, wealth, profit, parking, land"))
